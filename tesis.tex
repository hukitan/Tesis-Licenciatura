...
\section{Discusión}
La presente tesis buscó la asociación entre la eficiencia de memoria de trabajo y las variaciones diurnas. Se encontró que aunque sí se observa una menor eficiencia en manipular información con respecto a sólo mantenerla, independientemente del momento del día, lo que replica los estudios previos reportados por \citeA{DEsposito2015} y por \citeA{Veltman2003}; esto se observa en el porcentaje de respuestas correctas, el tiempo de reacción, el indice d’ y la eficiencia inversa. Sin embargo, no se encuentran diferencias independientemente del cronotipo a lo largo del día, ni por eficiencia general de la memoria de trabajo ni por sus subprocesos. 
...
Otro factor que podria ser es la iluminación a la que son expuestos los individuos ya que se ha reportado, que el uso de pantallas o la iluminacion ambiental genera una modificacion en la fase circadiana de las personas \cite{Chang2015,Chang2011,Gronfier2007}.

Ambos factores de iluminación, como la rutina diaria pueden estar generando un sindrome de sueño insuficiente en nuestros participantes que podrian estar teniendo un efecto no controlado en nuestros participantes.
El Sindrome de sueño insuficiente es un trastorno de sueño no patologico en el que el individuo se somente a una privación voluntaria, aunque no intencional, crónica del sueño. Presenta una capacidad intacta o por encima de la media para iniciar y mantener el sueño. El examen del estado mental y la evaluación psicológica revelan poca o ninguina psicopatología, y el examen físico no revela ninguna explicación médica a la condición.

Generar una historia detallada del patrón de sueño actual en relación con las cantidades de sueño rutinariamente obtenido, y la cantidad de sueño deseado, permite observar una disparidad entre la necesidad de dormir y la la cantidad realmente obtenida es sustancial, y su importancia no es apreciada por el paciente. 
El tiempo de sueño prolongado los fines de semana en comparación con los días de semana, es un indicador común de este trastorno \cite{AASM2001}.
